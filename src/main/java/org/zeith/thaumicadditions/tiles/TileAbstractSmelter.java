...
import org.zeith.thaumicadditions.inventory.container.ContainerAbstractSmelter;
import org.zeith.thaumicadditions.inventory.gui.GuiAbstractSmelter;
		...
		implements ISidedInventory
{
	...
	public boolean isItemValidForSlot(int par1, ItemStack stack2)
	{
		...
		if(par1 == 0 && (al = ThaumcraftCraftingManager.getObjectTags(stack2)) != null && al.size() > 0)
			return true;
		return par1 == 1 && TileSmelter.isItemFuel(stack2);
	}
