...
public class ItemVoidElementalPickaxe extends ItemElementalPickaxe
{
	public ItemVoidElementalPickaxe()
	{
		...
		setTranslationKey("void_elemental_pickaxe");
	}
	
	@Override
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		if(!worldIn.isRemote && stack.getItemDamage() > 0 && entityIn.ticksExisted % 8 == 0 && worldIn.rand.nextBoolean())
		{
