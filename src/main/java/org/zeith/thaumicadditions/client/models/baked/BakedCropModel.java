package org.zeith.thaumicadditions.client.models.baked;
...
import static org.zeith.thaumicadditions.blocks.plants.BlockVisCrop.AGE_5;

public class BakedCropModel
		implements IBakedModel
{
	public static final String[] textures0 = new String[]{
	...
	public static final String[] textures1 = new String[]{
			"",
			"",
		...
		for(TextureAtlasSprite sprite : sprites)
		{
			if(side.getAxis() == Axis.X)
			{
				quads.add(FACE_BAKERY.makeBakedQuad( //
						...
						new BlockPartFace(null, index, "#crop", new BlockFaceUV(new float[]{
								0,
								0,
								16,
								16
