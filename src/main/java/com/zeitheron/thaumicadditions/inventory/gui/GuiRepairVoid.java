...
import com.zeitheron.thaumicadditions.net.PacketSetVoidItemName;
...
public class GuiRepairVoid extends GuiContainer implements IContainerListener
{
	private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
	private final ContainerRepairVoid anvil;
	private GuiTextField nameField;
	private final InventoryPlayer playerInventory;
	
	public GuiRepairVoid(InventoryPlayer inventoryIn, World worldIn, BlockPos posIn)
	{
		super(new ContainerRepairVoid(inventoryIn, worldIn, posIn, Minecraft.getMinecraft().player));
		this.playerInventory = inventoryIn;
		this.anvil = (ContainerRepairVoid) this.inventorySlots;
	}
	...
	private void renameItem()
	{
		...
		HCNet.INSTANCE.sendToServer(PacketSetVoidItemName.create(s));
	}
