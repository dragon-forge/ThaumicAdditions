		...
		extends RecipeRegistry
{
	...
	private void init()
	{
		...
		ForgeRegistries.BLOCKS.getValuesCollection()
				...
				.forEach(log ->
				{
					EnumAxis axis = log.getValue(BlockLog.LOG_AXIS);
	...
	private void infusing()
	{
		...
		addInfusionRecipe("enchanted_golden_apple", new ItemStack(Items.GOLDEN_APPLE, 1, 1), "TAR_ENCHANTED_GOLDEN_APPLE", 6, new ItemStack(Items.GOLDEN_APPLE, 1, 0), new AspectList().add(Aspect.DESIRE, 10).add(Aspect.LIFE, 5).add(KnowledgeTAR.VISUM, 20), new ItemStack(Blocks.GOLD_BLOCK), AspectUtil.crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), AspectUtil.crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), AspectUtil.crystalEssence(Aspect.DESIRE), new ItemStack(Blocks.GOLD_BLOCK), AspectUtil.crystalEssence(Aspect.DESIRE));
