...
public class TAReconstructed
{
	...
	public static void setupShadowEnchanting()
	{
		...
		ShadowEnchantment.registerEnchantment(Enchantments.BANE_OF_ARTHROPODS, ShadowEnchantment.aspectBuilder().multiplyByLvl(Aspect.AVERSION, 20).multiplyByLvl(Aspect.BEAST, 10).constant(KnowledgeTAR.EXITIUM, 20), new ResourceLocation(InfoTAR.MOD_ID, "textures/enchantments/bane_of_arthropods.png"), null);
