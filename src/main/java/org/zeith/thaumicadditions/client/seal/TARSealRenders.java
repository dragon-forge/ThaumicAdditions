...
import org.zeith.thaumicadditions.client.util.GLDownloader;
import org.zeith.thaumicadditions.config.ConfigsTAR;
import org.zeith.thaumicadditions.entity.EntitySealViewer;
...
public class TARSealRenders
{
	...
	static
	{
		MinecraftForge.EVENT_BUS.register(TARSealRenders.class);
	}

	public static void renderNone(TileSeal seal, float partialTicks)
	{
		// NO-OP
	}

	public static void renderPortal(TileSeal seal, float partialTicks)
	{
	...
	public static void renderStandart(TileSeal seal, float partialTicks, int index)
	{
		...
		GL11.glPushMatrix();
		GL11.glTranslated(-8 / 16D, -6 / 16D, -.01 * (index + 1));
