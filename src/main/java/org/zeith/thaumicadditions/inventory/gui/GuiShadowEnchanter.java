...
import org.zeith.thaumicadditions.net.PacketHandleShadowLvl;
...
public class GuiShadowEnchanter
		extends GuiWTFMojang<ContainerShadowEnchanter>
{
	public static final ResourceLocation tex = new ResourceLocation(InfoTAR.MOD_ID, "textures/gui/shadow_enchanter.png");
	final Rectangle enchantmentArea = new Rectangle();	static final int RECIPE_Y = 16, SELECT_Y = 53, Y_DELTA = SELECT_Y - RECIPE_Y;
