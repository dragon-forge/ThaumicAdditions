...
public class KnowledgeTAR
{
	...
	public static final Aspect CAELES = new CustomColoredAspect("caeles", 0xFF0000, new Aspect[] { Aspect.MAN, Aspect.DESIRE }, new ResourceLocation(InfoTAR.MOD_ID, "textures/aspects/caeles.png"), 1, CustomColoredAspect.RAINBOW);
	...
	private static void $init()
	{
		...
		new REB().setBaseInfo("TAR_AURA_DISPERSER", "aura_disperser", 0, -2, new ItemStack(BlocksTAR.AURA_DISPERSER)).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aura_disperser.1").setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, TAReconstructed.RES_CAT, 1), new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("ALCHEMY"), 1)).setConsumedItems(new ItemStack(ItemsTAR.SALT_ESSENCE)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aura_disperser.2").setRecipes(InfoTAR.MOD_ID + ":aura_disperser").build()).setParents("BASEARTIFICE", "METALLURGY@2", "TAR_ESSENCE_SALT").buildAndRegister();
		
		new REB().setBaseInfo("TAR_SEAL", "seal", -2, -1, new ItemStack(BlocksTAR.SEAL)).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":seal.1").setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, TAReconstructed.RES_CAT, 1)).setConsumedItems(new ItemStack(Items.GOLD_INGOT), new ItemStack(Blocks.WOOL)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":seal.2").setRecipes(new ResourceLocation(InfoTAR.MOD_ID, "seal")).build()).setParents("TAR_THAUMADDS").buildAndRegister();
		...
		new REB().setBaseInfo("TAR_TOTEMS", "totems", 2, 1, new ItemStack(BlocksTAR.DAWN_TOTEM), new ItemStack(BlocksTAR.TWILIGHT_TOTEM)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.1").setResearch("!FluxRift").setResearchIcons("thaumcraft:textures/research/r_fluxrift.png").setKnow(new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("AUROMANCY"), 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.2").setResearch("!TARShimmerleaf").setResearchIcons(InfoTAR.MOD_ID + ":textures/research/shimmerleaf.png").setKnow(new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("AUROMANCY"), 1)).setRecipes(InfoTAR.MOD_ID + ":twilight_totem").build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.3").setRecipes(InfoTAR.MOD_ID + ":twilight_totem", InfoTAR.MOD_ID + ":dawn_totem").build()).setParents("TAR_THAUMADDS").buildAndRegister();
		new REB().setBaseInfo("TAR_PURIFLOWER", "puriflower", 2, 3, new ItemStack(BlocksTAR.PURIFLOWER)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":puriflower.1").setConsumedItems(new ItemStack(BlocksTC.vishroom)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, ResearchCategories.getResearchCategory("ALCHEMY"), 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":puriflower.2").setRecipes(InfoTAR.MOD_ID + ":puriflower").build()).setParents("TAR_TOTEMS").buildAndRegister();
		...
		new REB().setBaseInfo("TAR_CAKE", "arcane_cake", 1, 1, new ItemStack(BlocksTAR.CAKE)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":arcane_cake.1").setRequiredCraft(new ItemStack(Items.CAKE)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, TAReconstructed.RES_CAT, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":arcane_cake.2").setRecipes(InfoTAR.MOD_ID + ":arcane_cake").build()).setParents("TAR_THAUMADDS").buildAndRegister();
		new REB().setBaseInfo("TAR_KNOWLEDGE_TOME", "knowledge_tome", -3, -1, new ItemStack(ItemsTAR.KNOWLEDGE_TOME)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":knowledge_tome.1").setConsumedItems(new ItemStack(ItemsTC.thaumonomicon)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, TAReconstructed.RES_CAT, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":knowledge_tome.2" + (!ConfigsTAR.reusable ? "_noreuse" : "")).setRecipes(InfoTAR.MOD_ID + ":knowledge_tome").build()).setParents("TAR_THAUMADDS").buildAndRegister();
		new REB().setBaseInfo("TAR_CHESTER", "chester", -4, -1, new ItemStack(ItemsTAR.CHESTER)).setMeta(EnumResearchMeta.SPIKY).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":chester.1").setConsumedItems(new ItemStack(BlocksTC.logGreatwood)).setRequiredCraft(new ItemStack(ItemsTC.golemBell)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, ResearchCategories.getResearchCategory("GOLEMANCY"), 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":chester.2").setRecipes(InfoTAR.MOD_ID + ":chester", InfoTAR.MOD_ID + ":bone_eye").build()).setParents("TAR_THAUMADDS").buildAndRegister();
		...
		new REB().setBaseInfo("TAR_VIS_SCRIBING_TOOLS", "vis_scribing_tools", -5, -1, new ItemStack(ItemsTAR.VIS_SCRIBING_TOOLS)).setMeta(EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":vis_scribing_tools.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("BASICS"), 1), new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 1)).setConsumedItems(new ItemStack(ItemsTC.scribingTools)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":vis_scribing_tools.2").setRecipes(InfoTAR.MOD_ID + ":vis_scribing_tools").build()).setParents("TAR_THAUMADDS", "RECHARGEPEDESTAL").buildAndRegister();
		
		new REB().setBaseInfo("TAR_VOID_THAUMOMETER", "void_thaumometer", 0, 2, new ItemStack(ItemsTAR.VOID_THAUMOMETER)).setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.SPIKY).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_thaumometer.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 1), new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("ELDRITCH"), 1)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_thaumometer.2").setRecipes(InfoTAR.MOD_ID + ":void_thaumometer").build()).setParents("TAR_THAUMADDS", "BASEELDRITCH").buildAndRegister();
		new REB().setBaseInfo("TAR_WORMHOLE_MIRROR", "wormhole_mirror", 0, 4, new ItemStack(ItemsTAR.WORMHOLE_MIRROR)).setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.SPIKY).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":wormhole_mirror.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 2), new Knowledge(EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("ELDRITCH"), 2)).setWarp(3).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":wormhole_mirror.2").setRecipes(InfoTAR.MOD_ID + ":wormhole_mirror").build()).setParents("TAR_VOID_THAUMOMETER", "MIRRORHAND").buildAndRegister();
		
		new REB().setBaseInfo("TAR_ADAMINITE_FABRIC", "adaminite_fabric", 1, -6, new ItemStack(ItemsTAR.ADAMINITE_FABRIC)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_fabric.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 1)).setConsumedItems(new ItemStack(ItemsTC.fabric)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_fabric.2").setRecipes(InfoTAR.MOD_ID + ":adaminite_fabric", InfoTAR.MOD_ID + ":adaminite_hood", InfoTAR.MOD_ID + ":adaminite_robe", InfoTAR.MOD_ID + ":adaminite_belt", InfoTAR.MOD_ID + ":adaminite_boots").build()).setParents("TAR_ADAMINITE").buildAndRegister();
		new REB().setBaseInfo("TAR_MITHMINITE_FABRIC", "mithminite_fabric", 2, -8, new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_fabric.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 1)).setRequiredCraft(new ItemStack(ItemsTAR.ADAMINITE_FABRIC)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_fabric.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_fabric").build()).setParents("TAR_ADAMINITE_FABRIC", "TAR_MITHMINITE").buildAndRegister();
		
		new REB().setBaseInfo("TAR_MITHMINITE_HOOD", "mithminite_hood", -1, -10, new ItemStack(ItemsTAR.MITHMINITE_HOOD)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_hood.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 2)).setConsumedItems(new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setWarp(5).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_hood.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_hood").build()).setParents("TAR_MITHMINITE_FABRIC", "TAR_SEAL_GLOBE", "ARCANELAMP", "WARP", "JARBRAIN").buildAndRegister();
		new REB().setBaseInfo("TAR_MITHMINITE_ROBE", "mithminite_robe", 1, -10, new ItemStack(ItemsTAR.MITHMINITE_ROBE)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_robe.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 2)).setConsumedItems(new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setWarp(5).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_robe.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_robe").build()).setParents("TAR_MITHMINITE_FABRIC", "SEALGUARD").buildAndRegister();
		new REB().setBaseInfo("TAR_MITHMINITE_BELT", "mithminite_belt", 3, -10, new ItemStack(ItemsTAR.MITHMINITE_BELT)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_belt.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 2)).setConsumedItems(new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setWarp(5).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_belt.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_belt").build()).setParents("TAR_MITHMINITE_FABRIC").buildAndRegister();
		new REB().setBaseInfo("TAR_MITHMINITE_BOOTS", "mithminite_boots", 5, -10, new ItemStack(ItemsTAR.MITHMINITE_BOOTS)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_boots.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, TAReconstructed.RES_CAT, 2)).setConsumedItems(new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setWarp(5).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_boots.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_boots").build()).setParents("TAR_MITHMINITE_FABRIC", "BOOTSTRAVELLER").buildAndRegister();
	}
