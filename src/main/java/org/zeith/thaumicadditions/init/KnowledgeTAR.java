...
import org.zeith.thaumicadditions.api.*;
...
public class KnowledgeTAR
{
	...
	public static final Aspect FLUCTUS = createAspect("fluctus", () -> new Aspect("fluctus", 0xA8A8A8, new Aspect[] {
			Aspect.MOTION,
			Aspect.WATER
	}, InfoTAR.id("textures/aspects/fluctus.png"), 1));
	
	public static final Aspect SONUS = createAspect("sonus", () -> new Aspect("sonus", 0xFFAA00, new Aspect[] {
			FLUCTUS,
			Aspect.AIR
	}, InfoTAR.id("textures/aspects/sonus.png"), 1));
	
	public static final Aspect EXITIUM = createAspect("exitium", () -> new Aspect("exitium", 0x777777, new Aspect[] {
			Aspect.ENTROPY,
			Aspect.TOOL
	}, InfoTAR.id("textures/aspects/exitium.png"), 1));
	
	public static final Aspect CAELES = createAspect("caeles", () -> new CustomColoredAspect("caeles", 0xFF0000, new Aspect[] {
			Aspect.MAN,
			Aspect.DESIRE
	}, InfoTAR.id("textures/aspects/caeles.png"), 1, CustomColoredAspect.RAINBOW));
	
	public static final Aspect DRACO = createAspect("draco", () -> new Aspect("draco", 0x00BCFF, new Aspect[] {
			CAELES,
			Aspect.LIFE
	}, InfoTAR.id("textures/aspects/draco.png"), 1));
	
	public static final Aspect INFERNUM = createAspect("infernum", () -> new Aspect("infernum", 0xFF2314, new Aspect[] {
			Aspect.FIRE,
			Aspect.DEATH
	}, InfoTAR.id("textures/aspects/infernum.png"), 1));
	
	public static final Aspect VENTUS = createAspect("ventus", () -> new Aspect("ventus", 0xFCFCCF, new Aspect[] {
			Aspect.AIR,
			Aspect.FLIGHT
	}, InfoTAR.id("textures/aspects/ventus.png"), 1));
	
	public static final Aspect VISUM = createAspect("visum", () -> new Aspect("visum", 0x45CF35, new Aspect[] {
			Aspect.SENSES,
			Aspect.CRYSTAL
	}, InfoTAR.id("textures/aspects/visum.png"), 1));
	
	public static final Aspect IMPERIUM = createAspect("imperium", () -> new Aspect("imperium", 0xD6A255, new Aspect[] {
			Aspect.MIND,
			Aspect.MECHANISM
	}, InfoTAR.id("textures/aspects/imperium.png"), 1));
	...
	public static Aspect createAspect(String tag, Supplier<Aspect> factory)
	{
		Aspect.aspects.remove(tag); // Prevent crashing due to mod loading order.
		return factory.get();
	}
	...
	private static void $init()
	{
		...
		{
			new REB().setBaseInfo("TAR_ESSENCE_SALT", "essence_salt", -2, -2, AspectUtil.salt(Aspect.AURA))
					...
					.buildAndRegister();
			{
				new REB().setBaseInfo("TAR_CRYSTAL_CRUSHER", "crystal_crusher", -2, -4, new ItemStack(BlocksTAR.CRYSTAL_CRUSHER))
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":crystal_crusher.1").setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1)).setConsumedItems(new ItemStack(ItemsTC.mechanismSimple)).setRequiredCraft(new ItemStack(ItemsTC.mechanismComplex)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":crystal_crusher.2").setRecipes(InfoTAR.MOD_ID + ":crystal_crusher").build())
						.setParents("TAR_ESSENCE_SALT", "METALLURGY@2", "BASEARTIFICE").setRewardItems(new ItemStack(ItemsTC.plate, 3, 0), new ItemStack(ItemsTC.plate, 2, 1)).buildAndRegister();
				new REB().setBaseInfo("TAR_AURA_DISPERSER", "aura_disperser", 0, -2, new ItemStack(BlocksTAR.AURA_DISPERSER))
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aura_disperser.1").setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1), new Knowledge(EnumKnowledgeType.THEORY, R_ALCHEMY, 1)).setConsumedItems(new ItemStack(ItemsTAR.SALT_ESSENCE)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aura_disperser.2").setRecipes(InfoTAR.MOD_ID + ":aura_disperser").build()).setParents("BASEARTIFICE", "METALLURGY@2", "TAR_ESSENCE_SALT")
						.buildAndRegister();
				new REB().setBaseInfo("TAR_ESSENTIA_PISTOL", "essentia_pistol", 0, -4, new ItemStack(ItemsTAR.ESSENTIA_PISTOL))
					...
					.buildAndRegister();
			{
				...
				new REB().setBaseInfo("TAR_SEAL_GLOBE", "seal_globe", -4, -10, new ItemStack(ItemsTAR.SEAL_GLOBE)).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":seal_globe.1").setRequiredCraft(new ItemStack(ItemsTC.visResonator)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":seal_globe.2").setRecipes(InfoTAR.MOD_ID + ":seal_globe").build()).setParents("TAR_SEAL_SYMBOLS")
						.setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.HEX).buildAndRegister();
			}
			new REB().setBaseInfo("TAR_KNOWLEDGE_TOME", "knowledge_tome", -6, -1, new ItemStack(ItemsTAR.KNOWLEDGE_TOME)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.HIDDEN)
			...
			new REB().setBaseInfo("TAR_CHESTER", "chester", -8, -1, new ItemStack(ItemsTAR.CHESTER)).setMeta(EnumResearchMeta.SPIKY)
			...
			new REB().setBaseInfo("TAR_VIS_SCRIBING_TOOLS", "vis_scribing_tools", -10, -1, new ItemStack(ItemsTAR.VIS_SCRIBING_TOOLS)).setMeta(EnumResearchMeta.HIDDEN)
					.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":vis_scribing_tools.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_BASICS, 1), new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1)).setConsumedItems(new ItemStack(ItemsTC.scribingTools)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":vis_scribing_tools.2").setRecipes(InfoTAR.MOD_ID + ":vis_scribing_tools").build()).setParents("TAR_THAUMADDS", "RECHARGEPEDESTAL")
					.buildAndRegister();
			
			//
			
			new REB().setBaseInfo("TAR_CRYSTAL_WATER", "crystal_water", -2, 2, FluidUtil.getFilledBucket(new FluidStack(FluidsTAR.CRYSTAL_WATER, Fluid.BUCKET_VOLUME)))
			...
			new REB().setBaseInfo("TAR_ENCHANTED_GOLDEN_APPLE", "enchanted_golden_apple", -4, 1, new ItemStack(Items.GOLDEN_APPLE, 1, 1))
			...
			new REB().setBaseInfo("TAR_CRYSTAL_BLOCK", "crystal_block", -6, 1, new ItemStack(BlocksTAR.CRYSTAL_BLOCK))
					.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":crystal_block.1").setConsumedItems(AspectUtil.crystalEssence(Aspect.AIR), AspectUtil.crystalEssence(Aspect.WATER), AspectUtil.crystalEssence(Aspect.FIRE), AspectUtil.crystalEssence(Aspect.EARTH), AspectUtil.crystalEssence(Aspect.ORDER), AspectUtil.crystalEssence(Aspect.ENTROPY)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_ARTIFICE, 1)).build(), new RSB().setText(
							"research_stage." + InfoTAR.MOD_ID + ":crystal_block.2").setRecipes(RecipesTAR.crystalBlockRecipeIDFake).build()).setParents("TAR_THAUMADDS").buildAndRegister();
			{
				new REB().setBaseInfo("TAR_GROWTH_CHAMBER", "growth_chamber", -6, 3, new ItemStack(BlocksTAR.GROWTH_CHAMBER)).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":growth_chamber.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1)).setConsumedItems(AspectUtil.crystalEssence(Aspect.PLANT)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":growth_chamber.2").setRecipes(InfoTAR.MOD_ID + ":growth_chamber").build())
						.setParents("TAR_CRYSTAL_BLOCK", "CRYSTALFARMER").setMeta(EnumResearchMeta.HIDDEN).buildAndRegister();
			}
			new REB().setBaseInfo("TAR_FRAGNANT_PENDANT", "fragnant_pendant", -8, 1, new ItemStack(ItemsTAR.FRAGNANT_PENDANT))
					.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":fragnant_pendant.1").setRequiredCraft(new ItemStack(ItemsTC.bathSalts), new ItemStack(ItemsTC.baubles, 1, 4)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ALCHEMY, 1), new Knowledge(EnumKnowledgeType.OBSERVATION, R_ELDRITCH, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":fragnant_pendant.2").setRecipes(InfoTAR.MOD_ID + ":odour_powder", InfoTAR.MOD_ID + ":fragnant_pendant").build())
					.setParents("TAR_THAUMADDS", "BATHSALTS").buildAndRegister();
			...
			{
				new REB().setBaseInfo("TAR_MOB_SUMMONING", "mob_summoning", 4, -1, new ItemStack(BlocksTAR.ENTITY_SUMMONER)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mob_summoning.1").setConsumedItems(AspectUtil.phial(Aspect.LIFE), AspectUtil.phial(Aspect.DEATH)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_INFUSION, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mob_summoning.2").setRequiredCraft(new ItemStack(ItemsTAR.ENTITY_CELL)).setRecipes(InfoTAR.MOD_ID + ":dna_sample").build(), new RSB().setText(
								"research_stage." + InfoTAR.MOD_ID + ":mob_summoning.3").setRecipes(InfoTAR.MOD_ID + ":dna_sample", InfoTAR.MOD_ID + ":mob_summoner").build()).setParents("TAR_MITHRILLIUM", "TAR_TOTEMS@2").buildAndRegister();
				new REB().setBaseInfo("TAR_ASPECT_COMBINER", "aspect_combiner", 6, -1, new ItemStack(BlocksTAR.ASPECT_COMBINER)).setMeta(EnumResearchMeta.HIDDEN)
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aspect_combiner.1").setRequiredCraft(new ItemStack(BlocksTC.centrifuge), new ItemStack(ItemsTAR.MITHRILLIUM_INGOT)).setConsumedItems(AspectUtil.phial(Aspect.EXCHANGE)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ALCHEMY, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aspect_combiner.2").setRecipes(InfoTAR.MOD_ID + ":aspect_combiner").build())
						.setParents("CENTRIFUGE", "TAR_MITHRILLIUM").buildAndRegister();
				new REB().setBaseInfo("TAR_MITHRILLIUM_JAR", "mithrillium_jar", 8, -1, new ItemStack(BlocksTAR.MITHRILLIUM_JAR)).setMeta(EnumResearchMeta.HIDDEN)
				...
				new REB().setBaseInfo("TAR_MITHRILLIUM_SMELTER", "mithrillium_smelter", 10, -1, new ItemStack(BlocksTAR.MITHRILLIUM_SMELTER)).setMeta(EnumResearchMeta.HIDDEN)
						...
						.buildAndRegister();
				new REB().setBaseInfo("TAR_SHADOW_ENCHANTER", "shadow_enchanter", 12, -1, new ItemStack(BlocksTAR.SHADOW_ENCHANTER)).setMeta(EnumResearchMeta.HIDDEN)
				...
				new REB().setBaseInfo("TAR_SHADOW_BEAM_STAFF", "shadow_beam_staff", 14, -1, new ItemStack(ItemsTAR.SHADOW_BEAM_STAFF)).setMeta(EnumResearchMeta.HIDDEN)
				...
				new REB().setBaseInfo("TAR_THE_BEHEADER", "the_beheader", 16, -1, new ItemStack(ItemsTAR.THE_BEHEADER)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.ROUND, EnumResearchMeta.HIDDEN)
				...
				new REB().setBaseInfo("TAR_ADAMINITE", "adaminite", 4, -4, new ItemStack(ItemsTAR.ADAMINITE_INGOT)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
				...
				{
					new REB().setBaseInfo("TAR_AURA_CHARGER", "aura_charger", 6, -3, new ItemStack(BlocksTAR.AURA_CHARGER)).setMeta(EnumResearchMeta.HIDDEN)
							.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":aura_charger.1").setRequiredCraft(new ItemStack(BlocksTAR.ASPECT_COMBINER), new ItemStack(ItemsTAR.ADAMINITE_NUGGET)).setConsumedItems(AspectUtil.phial(TileAuraCharger.AURA)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_AUROMANCY, 1), new Knowledge(EnumKnowledgeType.OBSERVATION, R_ALCHEMY, 1), new Knowledge(EnumKnowledgeType.THEORY, R_INFUSION, 1)).build(), new RSB().setText(
									"research_stage." + InfoTAR.MOD_ID + ":aura_charger.2").setRecipes(InfoTAR.MOD_ID + ":aura_charger").build()).setParents("TAR_ASPECT_COMBINER", "TAR_ADAMINITE").buildAndRegister();
					new REB().setBaseInfo("TAR_ADAMINITE_JAR", "adaminite_jar", 8, -3, new ItemStack(BlocksTAR.ADAMINITE_JAR)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN)
							.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_jar.1").setRequiredCraft(new ItemStack(BlocksTAR.MITHRILLIUM_JAR), new ItemStack(ItemsTAR.ADAMINITE_PLATE)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_ALCHEMY, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_jar.2").setRequiredCraft(new ItemStack(BlocksTAR.ADAMINITE_JAR)).setRecipes(InfoTAR.MOD_ID + ":adaminite_jar").build(), new RSB().setText(
									"research_stage." + InfoTAR.MOD_ID + ":adaminite_jar.3").setRecipes(InfoTAR.MOD_ID + ":adaminite_jar").build()).setParents("TAR_MITHRILLIUM_JAR", "TAR_ADAMINITE").buildAndRegister();
					new REB().setBaseInfo("TAR_ADAMINITE_SMELTER", "adaminite_smelter", 10, -3, new ItemStack(BlocksTAR.ADAMINITE_SMELTER)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN)
							.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_smelter.1").setRequiredCraft(new ItemStack(ItemsTAR.ADAMINITE_PLATE)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ALCHEMY, 1), new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_smelter.2").setRecipes(InfoTAR.MOD_ID + ":adaminite_smelter").build())
							.setParents("TAR_ADAMINITE", "TAR_MITHRILLIUM_SMELTER").buildAndRegister();
					new REB().setBaseInfo("TAR_ADAMINITE_SWORD", "adaminite_sword", 12, -3, new ItemStack(ItemsTAR.ADAMINITE_SWORD)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.ROUND, EnumResearchMeta.HIDDEN)
					...
					new REB().setBaseInfo("TAR_ADAMINITE_FABRIC", "adaminite_fabric", 3, -6, new ItemStack(ItemsTAR.ADAMINITE_FABRIC)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
							.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_fabric.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1)).setConsumedItems(new ItemStack(ItemsTC.fabric)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":adaminite_fabric.2")
									.setRecipes(InfoTAR.MOD_ID + ":adaminite_fabric", InfoTAR.MOD_ID + ":adaminite_hood", InfoTAR.MOD_ID + ":adaminite_robe", InfoTAR.MOD_ID + ":adaminite_belt", InfoTAR.MOD_ID + ":adaminite_boots").build()).setParents("TAR_ADAMINITE").buildAndRegister();
					new REB().setBaseInfo("TAR_MITHMINITE", "mithminite", 5, -6, new ItemStack(ItemsTAR.MITHMINITE_INGOT)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
					...
					{
						new REB().setBaseInfo("TAR_MITHMINITE_JAR", "mithminite_jar", 8, -5, new ItemStack(BlocksTAR.MITHMINITE_JAR)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN)
						...
						new REB().setBaseInfo("TAR_MITHMINITE_SMELTER", "mithminite_smelter", 10, -5, new ItemStack(BlocksTAR.MITHMINITE_SMELTER)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN)
								.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_smelter.1").setRequiredCraft(new ItemStack(BlocksTAR.ADAMINITE_SMELTER), new ItemStack(ItemsTAR.MITHMINITE_PLATE)).setConsumedItems(new ItemStack(ItemsTC.alumentum), new ItemStack(ItemsTC.crystalEssence)).setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ALCHEMY, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_smelter.2")
										.setRecipes(InfoTAR.MOD_ID + ":mithminite_smelter").build()).setParents("TAR_MITHMINITE", "TAR_ADAMINITE_SMELTER").buildAndRegister();
						new REB().setBaseInfo("TAR_MITHMINITE_SCYTHE", "mithminite_scythe", 12, -5, new ItemStack(ItemsTAR.MITHMINITE_SCYTHE)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.ROUND, EnumResearchMeta.HIDDEN)
								.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_scythe.1").setRequiredCraft(new ItemStack(ItemsTAR.MITHMINITE_PLATE)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":mithminite_scythe.2").setRecipes(InfoTAR.MOD_ID + ":mithminite_scythe", InfoTAR.MOD_ID + ":mithminite_blade", InfoTAR.MOD_ID + ":mithminite_handle").build())
								.setParents("TAR_MITHMINITE").buildAndRegister();
						
						//
						
						new REB().setBaseInfo("TAR_MITHMINITE_FABRIC", "mithminite_fabric", 4, -8, new ItemStack(ItemsTAR.MITHMINITE_FABRIC)).setMeta(EnumResearchMeta.ROUND, EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
						...
						{
							new REB().setBaseInfo("TAR_MITHMINITE_HOOD", "mithminite_hood", 1, -10, new ItemStack(ItemsTAR.MITHMINITE_HOOD)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
									...
									.buildAndRegister();
							new REB().setBaseInfo("TAR_MITHMINITE_ROBE", "mithminite_robe", 3, -10, new ItemStack(ItemsTAR.MITHMINITE_ROBE)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
							...
							new REB().setBaseInfo("TAR_MITHMINITE_BELT", "mithminite_belt", 5, -10, new ItemStack(ItemsTAR.MITHMINITE_BELT)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
							...
							new REB().setBaseInfo("TAR_MITHMINITE_BOOTS", "mithminite_boots", 7, -10, new ItemStack(ItemsTAR.MITHMINITE_BOOTS)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
			...
			new REB().setBaseInfo("TAR_CAKE", "arcane_cake", 2, 2, new ItemStack(BlocksTAR.CAKE)).setMeta(EnumResearchMeta.HEX, EnumResearchMeta.HIDDEN).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":arcane_cake.1").setRequiredCraft(new ItemStack(Items.CAKE)).setKnow(new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":arcane_cake.2").setRecipes(InfoTAR.MOD_ID + ":arcane_cake").build())
					.setParents("TAR_THAUMADDS", "PRIMPEARL").buildAndRegister();
			new REB().setBaseInfo("TAR_TOTEMS", "totems", 4, 1, new ItemStack(BlocksTAR.DAWN_TOTEM), new ItemStack(BlocksTAR.TWILIGHT_TOTEM)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
					.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.1").setResearch("!FluxRift").setResearchIcons("thaumcraft:textures/research/r_fluxrift.png").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_AUROMANCY, 1)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.2").setResearch("!TARShimmerleaf").setResearchIcons(InfoTAR.MOD_ID + ":textures/research/shimmerleaf.png").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_AUROMANCY, 1))
							.setRecipes(InfoTAR.MOD_ID + ":twilight_totem").build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":totems.3").setRecipes(InfoTAR.MOD_ID + ":twilight_totem", InfoTAR.MOD_ID + ":dawn_totem").build()).setParents("TAR_THAUMADDS").buildAndRegister();
			{
				new REB().setBaseInfo("TAR_PURIFLOWER", "puriflower", 4, 3, new ItemStack(BlocksTAR.PURIFLOWER)).setMeta(EnumResearchMeta.SPIKY, EnumResearchMeta.HIDDEN)
			...
			new REB().setBaseInfo("TAR_CRYSTAL_BORE", "crystal_bore", 6, 1, new ItemStack(BlocksTAR.CRYSTAL_BORE)).setMeta(EnumResearchMeta.SPIKY)
			...
			new REB().setBaseInfo("TAR_FLUX_CONCENTRATOR", "flux_concentrator", 10, 1, new ItemStack(BlocksTAR.FLUX_CONCENTRATOR))
			...
			new REB().setBaseInfo("TAR_DISENCHANT_FABRIC", "disenchant_fabric", 12, 1, new ItemStack(ItemsTAR.DISENCHANT_FABRIC))
					...
					.setMeta(EnumResearchMeta.HIDDEN).buildAndRegister();
			new REB().setBaseInfo("TAR_CRYSTAL_LAMP", "crystal_lamp", 14, 1, new ItemStack(BlocksTAR.CRYSTAL_LAMP))
					.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":crystal_lamp.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ARTIFICE, 1), new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1)).setConsumedItems(AspectUtil.crystalEssence(Aspect.LIGHT), new ItemStack(BlocksTC.plankGreatwood)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":crystal_lamp.2").setRecipes(InfoTAR.MOD_ID + ":crystal_lamp").build()).setParents("TAR_THAUMADDS")
					.buildAndRegister();
			...
			{
				new REB().setBaseInfo("TAR_VOID_THAUMOMETER", "void_thaumometer", 2, 7, new ItemStack(ItemsTAR.VOID_THAUMOMETER)).setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.HEX)
				...
				{
					new REB().setBaseInfo("TAR_WORMHOLE_MIRROR", "wormhole_mirror", 2, 5, new ItemStack(ItemsTAR.WORMHOLE_MIRROR)).setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.SPIKY)
				...
				new REB().setBaseInfo("TAR_VOID_CROP", "void_crop", 2, 9, new ItemStack(ItemsTAR.VOID_SEED)).setMeta(EnumResearchMeta.HIDDEN)
				...
				new REB().setBaseInfo("TAR_VOID_ANVIL", "void_anvil", 4, 7, new ItemStack(BlocksTAR.VOID_ANVIL))
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_anvil.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_ELDRITCH, 1), new Knowledge(EnumKnowledgeType.OBSERVATION, R_THAUMADDS, 1)).setConsumedItems(AspectUtil.crystalEssence(Aspect.ELDRITCH)).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_anvil.2").setRecipes(InfoTAR.MOD_ID + ":void_anvil").build()).setParents("TAR_ELDRITCH").setMeta(EnumResearchMeta.HIDDEN)
						.buildAndRegister();
				
				//
				
				new REB().setBaseInfo("TAR_VOID_ELEMENTAL_PICKAXE", "void_elemental_pickaxe", -2, 7, new ItemStack(ItemsTAR.VOID_ELEMENTAL_PICKAXE)).setMeta(EnumResearchMeta.HIDDEN)
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_pickaxe.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1), new Knowledge(EnumKnowledgeType.THEORY, R_ELDRITCH, 1)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_pickaxe.2").setRecipes(InfoTAR.MOD_ID + ":void_elemental_pickaxe").build()).setParents("TAR_ELDRITCH", "ELEMENTALTOOLS").buildAndRegister();
				new REB().setBaseInfo("TAR_VOID_ELEMENTAL_AXE", "void_elemental_axe", -2, 9, new ItemStack(ItemsTAR.VOID_ELEMENTAL_AXE)).setMeta(EnumResearchMeta.HIDDEN)
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_axe.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1), new Knowledge(EnumKnowledgeType.THEORY, R_ELDRITCH, 1)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_axe.2").setRecipes(InfoTAR.MOD_ID + ":void_elemental_axe").build()).setParents("TAR_ELDRITCH", "ELEMENTALTOOLS").buildAndRegister();
				new REB().setBaseInfo("TAR_VOID_ELEMENTAL_SHOVEL", "void_elemental_shovel", -4, 7, new ItemStack(ItemsTAR.VOID_ELEMENTAL_SHOVEL)).setMeta(EnumResearchMeta.HIDDEN)
						.setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_shovel.1").setKnow(new Knowledge(EnumKnowledgeType.THEORY, R_THAUMADDS, 1), new Knowledge(EnumKnowledgeType.THEORY, R_ELDRITCH, 1)).setWarp(2).build(), new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":void_elemental_shovel.2").setRecipes(InfoTAR.MOD_ID + ":void_elemental_shovel").build()).setParents("TAR_ELDRITCH", "ELEMENTALTOOLS").buildAndRegister();
				new REB().setBaseInfo("TAR_VOID_ELEMENTAL_HOE", "void_elemental_hoe", -4, 9, new ItemStack(ItemsTAR.VOID_ELEMENTAL_HOE)).setMeta(EnumResearchMeta.HIDDEN)
		...
		new REB().setBaseInfo("!TARBlueWolf", "blue_wolf", -6, -10, InfoTAR.id("textures/research/blue_wolf.png")).setMeta(EnumResearchMeta.HIDDEN, EnumResearchMeta.HEX).setStages(new RSB().setText("research_stage." + InfoTAR.MOD_ID + ":blue_wolf").build()).buildAndRegister();
		
		TAReconstructed.arcs.forEach(ITARC::addResearches);
	}
	...
	private static void $insertAspects()
	{
		...
		appendAspects(new ItemStack(ItemsTAR.VOID_FRUIT), new AspectList().add(Aspect.ELDRITCH, 4).add(Aspect.PLANT, 5).add(Aspect.MIND, 1));
