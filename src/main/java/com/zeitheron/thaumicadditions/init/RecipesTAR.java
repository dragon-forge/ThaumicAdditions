...
public class RecipesTAR extends RecipeRegistry
{
	...
	private void infusing()
	{
		...
		addInfusionRecipe("wormhole_mirror", new ItemStack(ItemsTAR.WORMHOLE_MIRROR), "TAR_WORMHOLE_MIRROR", 6, new ItemStack(ItemsTC.handMirror), new AspectList().add(Aspect.ELDRITCH, 50).add(KnowledgeTAR.IMPERIUM, 100).add(KnowledgeTAR.VISUM, 80), new ItemStack(ItemsTC.plate, 1, 3), new ItemStack(ItemsTAR.VOID_THAUMOMETER), new ItemStack(ItemsTC.plate, 1, 3));
