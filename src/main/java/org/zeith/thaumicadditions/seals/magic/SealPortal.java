package org.zeith.thaumicadditions.seals.magic;
...
import org.zeith.thaumicadditions.client.seal.PortalRenderer;
import org.zeith.thaumicadditions.client.seal.TARSealRenders;
import org.zeith.thaumicadditions.entity.EntitySealViewer;
import org.zeith.thaumicadditions.net.PacketReorientPlayer;
import org.zeith.thaumicadditions.net.PacketTP;
import org.zeith.thaumicadditions.seals.SealChunkLoader;
		...
		implements IGlowingEntity
{
			...
			extends SealCombination
	{
		...
		{
			return TARSealRenders::renderPortal;
		}
