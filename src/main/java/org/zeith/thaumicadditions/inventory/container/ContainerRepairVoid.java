...
public class ContainerRepairVoid
		extends Container
{
	...
	public ContainerRepairVoid(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
	{
		...
		this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
		{
			...
			public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack)
			{
				...
				float breakChance = ForgeHooks.onAnvilRepair(thePlayer, stack, ContainerRepairVoid.this.inputSlots.getStackInSlot(0), ContainerRepairVoid.this.inputSlots.getStackInSlot(1));
