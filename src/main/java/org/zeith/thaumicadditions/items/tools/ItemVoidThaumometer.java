...
public class ItemVoidThaumometer
		extends Item
{
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected)
	{
		...
		if(held && world.isRemote && entity.ticksExisted % 5 == 0 && entity instanceof EntityPlayer)
		{
			...
			if((mop = this.getRayTraceResultFromPlayerWild(world, (EntityPlayer) entity, true)) != null && mop.getBlockPos() != null && ScanningManager.isThingStillScannable((EntityPlayer) entity, mop.getBlockPos()))
